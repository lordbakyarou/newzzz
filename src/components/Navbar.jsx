...
const Navbar = () => {
  return (
    <nav className="flex max-sm:flex-col max-sm:items-center max-sm:gap-2 justify-between w-full p-5">
      <div className="flex gap-20 items-center">
        <div className="text-orange-500 text-3xl font-bold">Newzzz</div>
        <ul className="flex gap-5 text-md max-lg:hidden items-center font-semibold">
